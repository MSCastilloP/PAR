...
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Consultar Domicilio de Domiciliario: <em><?php echo $domiciliario -> getNombre() . " " . $domiciliario -> getApellido() . " " . $domiciliario -> getTelefono() . " " . $domiciliario -> getSalario() . " " . $domiciliario -> getRol() ?></em></h4>
		</div>
		<div class="card-body">
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr><th></th>
						...
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Ascendente' href='index.php?pid=<?php echo base64_encode("ui/domicilio/selectAllDomicilioByDomiciliario.php") ?>&idDomiciliario=<?php echo $_GET['idDomiciliario'] ?>&order=direccion&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="direccion" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Descendente' href='index.php?pid=<?php echo base64_encode("ui/domicilio/selectAllDomicilioByDomiciliario.php") ?>&idDomiciliario=<?php echo $_GET['idDomiciliario'] ?>&order=direccion&dir=desc'>
						...
						<?php if($order=="fecha" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Ascendente' href='index.php?pid=<?php echo base64_encode("ui/domicilio/selectAllDomicilioByDomiciliario.php") ?>&idDomiciliario=<?php echo $_GET['idDomiciliario'] ?>&order=fecha&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="fecha" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Descendente' href='index.php?pid=<?php echo base64_encode("ui/domicilio/selectAllDomicilioByDomiciliario.php") ?>&idDomiciliario=<?php echo $_GET['idDomiciliario'] ?>&order=fecha&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
						<th nowrap>Hora 
						<?php if($order=="hora" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Ascendente' href='index.php?pid=<?php echo base64_encode("ui/domicilio/selectAllDomicilioByDomiciliario.php") ?>&idDomiciliario=<?php echo $_GET['idDomiciliario'] ?>&order=hora&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="hora" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Descendente' href='index.php?pid=<?php echo base64_encode("ui/domicilio/selectAllDomicilioByDomiciliario.php") ?>&idDomiciliario=<?php echo $_GET['idDomiciliario'] ?>&order=hora&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
						<th nowrap>Precio 
						<?php if($order=="precio" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Ascendente' href='index.php?pid=<?php echo base64_encode("ui/domicilio/selectAllDomicilioByDomiciliario.php") ?>&idDomiciliario=<?php echo $_GET['idDomiciliario'] ?>&order=precio&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="precio" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Descendente' href='index.php?pid=<?php echo base64_encode("ui/domicilio/selectAllDomicilioByDomiciliario.php") ?>&idDomiciliario=<?php echo $_GET['idDomiciliario'] ?>&order=precio&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
						...
						<?php if($order=="descripcion" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Ascendente' href='index.php?pid=<?php echo base64_encode("ui/domicilio/selectAllDomicilioByDomiciliario.php") ?>&idDomiciliario=<?php echo $_GET['idDomiciliario'] ?>&order=descripcion&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="descripcion" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Descendente' href='index.php?pid=<?php echo base64_encode("ui/domicilio/selectAllDomicilioByDomiciliario.php") ?>&idDomiciliario=<?php echo $_GET['idDomiciliario'] ?>&order=descripcion&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
						<th nowrap>Cocinando 
						<?php if($order=="cocinando" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Ascendente' href='index.php?pid=<?php echo base64_encode("ui/domicilio/selectAllDomicilioByDomiciliario.php") ?>&idDomiciliario=<?php echo $_GET['idDomiciliario'] ?>&order=cocinando&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="cocinando" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Descendente' href='index.php?pid=<?php echo base64_encode("ui/domicilio/selectAllDomicilioByDomiciliario.php") ?>&idDomiciliario=<?php echo $_GET['idDomiciliario'] ?>&order=cocinando&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
						<th>Domiciliario</th>
					...
					<?php
					$domicilio = new Domicilio("", "", "", "", "", "", "", $_GET['idDomiciliario'], "");
					if($order!="" && $dir!="") {
						$domicilios = $domicilio -> selectAllByDomiciliarioOrder($order, $dir);
					} else {
						$domicilios = $domicilio -> selectAllByDomiciliario();
					}
					$counter = 1;
