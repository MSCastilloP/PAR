...
if(isset($_POST['update'])){
	$updateCliente = new Cliente($_SESSION['id'], $nombre, $apellido, $correo, "", "", $telefono, $direccion, "1");
	...
	$logCliente = new LogCliente("","Editar Profile Cliente", "Nombre: " . $nombre . "; Apellido: " . $apellido . "; Correo: " . $correo . "; Telefono: " . $telefono . "; Direccion: " . $direccion, date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
	$logCliente -> insert();
	$processed=true;
}
?>
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Editar Profile Cliente</h4>
				</div>
				<div class="card-body">
					<?php if($processed){ ?>
					...
					<?php } ?>
					<form id="form" method="post" action="index.php?pid=<?php echo base64_encode("ui/cliente/updateProfileCliente.php") ?>" class="bootstrap-form needs-validation"   >
