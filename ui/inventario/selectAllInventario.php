			...
			<table class="table table-striped table-hover">
				<thead>
					<tr><th></th>
						...
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/inventario/selectAllInventario.php") ?>&order=fecha&dir=asc'>
						...
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/inventario/selectAllInventario.php") ?>&order=fecha&dir=desc'>
						...
						<?php if($order=="cantidadInicial" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/inventario/selectAllInventario.php") ?>&order=cantidadInicial&dir=asc'>
							<span class='fas fa-sort-amount-up' data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Ascendente' ></span></a>
						<?php } ?>
						<?php if($order=="cantidadInicial" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/inventario/selectAllInventario.php") ?>&order=cantidadInicial&dir=desc'>
							<span class='fas fa-sort-amount-down' data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Descendente' ></span></a>
						<?php } ?>
						</th>
						<th nowrap>Unidades 
						<?php if($order=="unidades" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/inventario/selectAllInventario.php") ?>&order=unidades&dir=asc'>
							<span class='fas fa-sort-amount-up' data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Ascendente' ></span></a>
						<?php } ?>
						<?php if($order=="unidades" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/inventario/selectAllInventario.php") ?>&order=unidades&dir=desc'>
							<span class='fas fa-sort-amount-down' data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Descendente' ></span></a>
						<?php } ?>
						</th>
						...
						<?php if($order=="cantidadFinal" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/inventario/selectAllInventario.php") ?>&order=cantidadFinal&dir=asc'>
							<span class='fas fa-sort-amount-up' data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Ascendente' ></span></a>
						<?php } ?>
						<?php if($order=="cantidadFinal" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/inventario/selectAllInventario.php") ?>&order=cantidadFinal&dir=desc'>
							<span class='fas fa-sort-amount-down' data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Descendente' ></span></a>
						<?php } ?>
						</th>
						<th>Ingrediente</th>
					...
					if($order != "" && $dir != "") {
						$inventarios = $inventario -> selectAllOrder($order, $dir);
					} else {
						$inventarios = $inventario -> selectAll();
					}
					$counter = 1;
					foreach ($inventarios as $currentInventario) {
						...
						if($_SESSION['entity'] == 'Administrador') {
							echo "<a href='index.php?pid=" . base64_encode("ui/inventario/selectAllInventario.php") . "&idInventario=" . $currentInventario -> getIdInventario() . "&action=delete' onclick='return confirm(\"Confirma eliminar Inventario: " . $currentInventario -> getFecha() . "\")'><span class='fas fa-backspace' data-toggle='tooltip' data-placement='left' class='tooltipLink' data-original-title='Delete Inventario' ></span></a> ";
						}
						echo "</td>";
						echo "</tr>";
						$counter++;
